wp core install --url=172.17.0.2:5050 --title=Example --admin_user=supervisor --admin_password=strongpassword --admin_email=info@example.com --path=/var/www/localhost/htdocs/wordpress
